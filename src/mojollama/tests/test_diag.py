#!/usr/bin/env python3
"""Run with diagnostic cengine to dump expert weight data."""
...
# Use diagnostic library
lib = ctypes.CDLL('/onedev-workspace/work/src/mojollama/kernels/cengine_batch_diag.so')
