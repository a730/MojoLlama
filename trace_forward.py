"""Trace the forward pass to find where it hangs."""
import sys, time, gc
sys.path.insert(0, 'src')
import numpy as np
from mojollama.model.inference import load_model

logf = open('/tmp/opencode/trace.log', 'w')
def log(msg):
