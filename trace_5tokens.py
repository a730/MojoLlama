"""Trace forward pass with 5 tokens."""
import sys, time
...
# Use same code as forward method but with timing
seq_len = len(ids)
...
logits = x @ lm_w.T
print(f'Done! total={time.time()-t_start:.1f}s logits={logits.shape}')
