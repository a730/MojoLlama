...
@extern("tokenizer_load")
def tokenizer_load(d: UnsafePointer[UInt8, MutExternalOrigin]) abi("C") -> Int: ...
@extern("tokenize")
def tokenize_text(t: UnsafePointer[UInt8, MutExternalOrigin], c: UnsafePointer[Int, MutExternalOrigin]) abi("C") -> UnsafePointer[Int, MutExternalOrigin]: ...
@extern("detokenize")
def detokenize_text(ids: UnsafePointer[Int, MutExternalOrigin], c: Int) abi("C") -> UnsafePointer[UInt8, MutExternalOrigin]: ...
@extern("extract_user_message")
def extract_user_message(b: UnsafePointer[UInt8, MutExternalOrigin]) abi("C") -> UnsafePointer[UInt8, MutExternalOrigin]: ...
